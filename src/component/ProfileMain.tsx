      ...
      <div className="flex max-w-5xl justify-around  mx-auto p-4 bg-slate-200 text-[#51535D] ">
        <ul className="">
          ...
          <li className="font-semibold">
            Email :{" "}
            <span className="font-normal">
              {details.userEmail ? details.userEmail : "N/A"}
            </span>
          </li>
          <li className="font-semibold">
            Marital Status :{" "}
            <span className="font-normal">
              {details.martial ? details.martial : "N/A"}
            </span>
          </li>
          <li className="font-semibold">
            Gender:{" "}
          ...
          <li className="font-semibold">
            Education :{" "}
            <span className="font-normal">
              {details.education ? details.education : "N/A"}
            </span>
          </li>
          <li className="font-semibold">
            Family :{" "}
            <span className="font-normal">
              {details.family ? details.family : "N/A"}
            </span>
          </li>
          <li className="font-semibold">
            Employments :{" "}
            <span className="font-normal">
              {details.emplymeents ? details.emplymeents : "N/A"}
            </span>
          </li>
        </ul>
        <ul className="">
          ...
          <li className="font-semibold">
            Status :{" "}
            <span className="font-normal">
              {details.userStatus ? details.userStatus : "N/A"}
            </span>
          </li>
          <li className="font-semibold">
            Shift Type :{" "}
            <span className="font-normal">
              {details.shiftType ? details.shiftType : "N/A"}
            </span>
          </li>
          <li className="font-semibold">
            Awards :{" "}
