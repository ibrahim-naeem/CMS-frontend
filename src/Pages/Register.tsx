    ...
    <div className="container mx-auto flex justify-center items-center h-[100vh]">
      ...
      <div className='w-1/2 border bg-white rounded py-6'>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm py-2 text-[#CBCCD4]'>Enter your details below</p>
        </div>
        ...
        <form className='flex justify-center' onSubmit={handleSubmit}>
          ...
          <div className="w-2/3 flex flex-col items-center justify-center">
            ...
            <div className='w-full my-2'>
              <label className="block text-xs text-slate-400 font-semibold" htmlFor="username">
                USERNAME
              </label>
              <input onChange={e => setUsername(e.target.value)} className="border rounded my-1 py-2 px-4 w-full text-sm shadow focus:outline-none " id="username" type="text" placeholder="Username" />
            </div>
            {/* Email  */}
            <div className='w-full my-2'>
            ...
            <p>Already have an Account? <Link to="/login"><span className='text-[#3751FF] font-semibold'>Login here</span> </Link></p>
          </div>
          {/* Form Container End  */}
        </form>
        {/* FORM  END*/}
