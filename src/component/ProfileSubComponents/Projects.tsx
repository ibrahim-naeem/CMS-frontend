...
const Projects: FC<IProjectsProps> = (props) => {
    ...
    const getProjects = async () => {
        ...
        try {
            ...
            //     mapProjectData.project_id = projectRow.project_id;
            //     mapProjectData.director_id = projectRow.director_id;
            //     mapProjectData.manager_id = projectRow.manager_id
            //     mapProjectData.employees_id = projectRow.employees_id
            //     mapProjectData.project_name = projectRow.project_name
            //     mapProjectDataArray.push(mapProjectData)
            // })
                                ...
                                return (
                                    <tr key={row?.project_id}>
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 flex items-center">
                                            ...
                                            {row?.project_id &&
                                                <button onClick={(e) => handleDelete(row?.project_id)} className='flex text-3xl text-red-500'><MdOutlineDeleteSweep /></button>}
                                        </td>
