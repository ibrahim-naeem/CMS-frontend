...
const Input = (item: any) => {
  return (
    <div className='flex justify-start items-center  mx-6'>
      ...
      <li className='ml-6 py-2 px-4active:bg-[#3F4049] hover:bg-[#3F4049]'>{item} </li>
    </div>
  )
}
...
const SideBar: FC<ISideBarProps> = (props) => {
  ...
  return (
    <div className='fixed bg-background  h-[100vh] '>
      <div className='flex justify-between items-center my-4 py-4 px-8 '>
        <img className='w-10 h-10' src={logo} alt='' />
        <h1 className='text-xl font-bold text-[#51535D]'><Link to="/">Dashboard Kit</Link></h1>
      </div>
      <div className='text-[#51535D]  py-4'>
        <ul className='text-lg border-b- mb-4 py-2'>
          <div className='flex justify-start items-center  active:bg-[#3F4049] hover:bg-[#3F4049]'>
            <AiOutlineProfile className='text-2xl ml-8' />
            <li className='ml-6 py-4 px-4 '> <Link to="/profile" >Profile</Link></li>
          </div>

          <div className='flex justify-start items-center  active:bg-[#3F4049] hover:bg-[#3F4049]'>
            <AiOutlineDashboard className='text-2xl ml-8' />
            <li className='ml-6 py-4 px-4 '><Link to="/dashboard">Dashboard</Link></li>
          </div>
        ...
        <ul className='text-lg'>
          ...
          <div className='flex justify-start items-center  active:bg-[#3F4049] hover:bg-[#3F4049]'>
            ...
            <li className='ml-6 py-4 px-4 active:bg-[#3F4049] hover:bg-[#3F4049]'>Subscription </li>
          </div>
        </ul>
      </div>
    </div>
