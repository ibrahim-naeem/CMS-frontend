...
const ProjectModal: FC<IProjectModalProps> = ({
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let selectValue = e.target.Projects.value;
    let inputValue = e.target.ProjectName.value;
    if (selectValue || inputValue) {
      if (inputValue) {
        selectValue = "";
      }
      let ProjectName = selectValue || inputValue;
      ...
      console.log("Please select Project or enter a Project");
    }
  };
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="flex justify-around ">
                <div className="w-2/3">
                  ...
                  <h1 className="my-4">Add new Project below :</h1>
